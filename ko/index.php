...
<meta property="og:title" content="크리스 헤서링턴">
<meta property="og:image" content="https://chrishetherington.com/images/social-media-image.jpg">
<meta property="og:description" content="일이 잘 되고 예쁘게 보이는 풀 스택 개발자. 모든 분야의 잭도 마찬가지야, 우리 같이 한 잔 하자꾸나.">
<meta property="og:url" content="https://chrishetherington.com/ko">
	...
	<div id="wrapper">
		...
		<header id="header">
			...
			<div class="content">
				<div class="inner">
					<h1>크리스 헤서링턴</h1>
					<p>코딩을 좋아하고 저와 제 고객을 위한 놀랍고 독특한 프로젝트를 만드는 것을 좋아하는 풀 스택 개발자이자 디자이너입니다. 오늘 우리는 무엇을 창조해야 할까요?</p>
					<p><b>사이트는 아직 작업 중입니다. 죄송합니다</b></p>
					<p><img src="images/chris-signature.png" alt="Signature"></p>
					<br />
					<h2>내이력서보기</h2>
					<button type="button">여기를 클릭하세요.</button>
				</div>
			</div>
			<nav>
				<ul>
					<li><a href="#intro">도입부</a></li>
					<li><a href="#work">일해요</a></li>
					<li><a href="#about">대해서요</a></li>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
		...
		<footer id="footer">
			<p class="copyright">&copy; Chris Hetherington. Coded with 💖 in Texas</p>
				&nbsp
				<p><a href="/jp/">日本語</a>　｜　<a href="/../">English</a></p>
		</footer>
