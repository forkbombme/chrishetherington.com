...
<meta property="og:title" content="クリス·ヘザリントン">
<meta property="og:image" content="https://chrishetherington.com/images/social-media-image.jpg">
<meta property="og:description" content="完全なスタック開発者は、物事をうまく機能させ、美しく見せる。 ジャックも一緒にお酒を飲みましょう。">
<meta property="og:url" content="https://chrishetherington.com/jp">
	...
	<div id="wrapper">
		...
		<header id="header">
			...
			<div class="content">
				<div class="inner">
					<h1>クリス·ヘザリントン</h1>
					<p>フルスタックの開発者でありデザイナーであり、私自身とクライアントのために驚くべきユニークなプロジェクトをコーディングして作成することが大好きです。 今日は何を作ろうか？</p>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
		...
		<footer id="footer">
			<p class="copyright">&copy; Chris Hetherington. Coded with 💖 in Texas</p>
				&nbsp
			<p> <a href="/../">English</a>　｜　<a href="/ko/">한국인</a> </p>
		</footer>
